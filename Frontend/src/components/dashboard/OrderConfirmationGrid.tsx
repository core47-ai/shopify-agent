  ...
  return (
    <div className="space-y-4">
      ...
      {(filters.trackingId || filters.orderId || filters.assignedCourier || filters.status || filters.deliveryStatus) && (
        <div className="flex flex-wrap gap-2 px-4 py-2 bg-white/5 rounded-lg border border-white/10">
      ...
      <div className="bg-white/5 rounded-lg border border-white/10 overflow-hidden">
        <ScrollArea className="w-full">
          <div className="min-w-[1200px]">
            {/* Header with filters */}
            <div className="grid grid-cols-12 gap-4 px-4 py-3 font-medium text-sm border-b border-white/10 bg-white/5">
              ...
              <div className="space-y-1">
                {filteredOrders.map((order: any) => (
                  <div key={order.id} className="space-y-1">
                    <div className="grid grid-cols-12 gap-4 px-4 py-3 text-sm hover:bg-white/5 transition-colors duration-200">
                      <div className="col-span-1 flex items-center">
                        <Button
                          variant="ghost"
                          size="sm"
